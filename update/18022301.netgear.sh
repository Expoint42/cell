...
set_wifidog() {
    # install package
    opkg install ./netgear-wndr3700-v4/fping_4.0-2_mips_24kc.ipk
    opkg install ./netgear-wndr3700-v4/libevent2_2.1.8-1_mips_24kc.ipk
    opkg install ./netgear-wndr3700-v4/libevent2-openssl_2.1.8-1_mips_24kc.ipk
    opkg install ./netgear-wndr3700-v4/apfree_wifidog_2.10.1437-1_mips_24kc.ipk
